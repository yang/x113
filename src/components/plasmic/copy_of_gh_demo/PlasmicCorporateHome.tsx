...
import sty from "./PlasmicCorporateHome.module.css"; // plasmic-import: 8eUnD3UhSH-wvT/css
...
export type PlasmicCorporateHome__VariantMembers = {};
export type PlasmicCorporateHome__VariantsArgs = {};
type VariantPropType = keyof PlasmicCorporateHome__VariantsArgs;
export const PlasmicCorporateHome__VariantProps = new Array<VariantPropType>();

export type PlasmicCorporateHome__ArgsType = {};
type ArgPropType = keyof PlasmicCorporateHome__ArgsType;
export const PlasmicCorporateHome__ArgProps = new Array<ArgPropType>();

export type PlasmicCorporateHome__OverridesType = {
  root?: p.Flex<"div">;
...
export interface DefaultCorporateHomeProps {
  className?: string;
}
...
function PlasmicCorporateHome__RenderFunc(props: {
  variants: PlasmicCorporateHome__VariantsArgs;
  args: PlasmicCorporateHome__ArgsType;
  overrides: PlasmicCorporateHome__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCorporateHome__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCorporateHome__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicCorporateHome__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCorporateHome__ArgProps,
          internalVariantPropNames: PlasmicCorporateHome__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCorporateHome__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCorporateHome";
  } else {
    func.displayName = `PlasmicCorporateHome.${nodeName}`;
  }
  return func;
}

export const PlasmicCorporateHome = Object.assign(
  // Top-level PlasmicCorporateHome renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCorporateHome
    internalVariantProps: PlasmicCorporateHome__VariantProps,
    internalArgProps: PlasmicCorporateHome__ArgProps,
...
export default PlasmicCorporateHome;
/* prettier-ignore-end */
