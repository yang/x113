...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: pM1q8bYTzZG8-N/css

import checklistpng8PbKjqpTzJg8G from "./images/checklistpng.png"; // plasmic-import: 8_pbKJQPTzJG8g/picture
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__aerqs)}>
            <p.PlasmicImg
          ...
          <div className={classNames(projectcss.all, sty.column___4WYzd)}>
            <h5
