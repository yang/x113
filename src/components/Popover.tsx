...
import {
  PlasmicPopover,
  DefaultPopoverProps
} from "./plasmic/copy_of_gh_demo/PlasmicPopover";
...
function Popover_(props: PopoverProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicPopover root={{ ref }} {...props} />;
}

const Popover = React.forwardRef(Popover_);
